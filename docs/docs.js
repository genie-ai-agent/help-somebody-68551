...
// DECIDED Aug 14: scout carry is 33% of the deal carry, i.e. equal thirds with Andrew and Iqram.
...
window.DOCS = [
  ...
  },
  {
    ...
    kicker: "One third of the deal carry \u00b7 decided Aug 14 \u00b7 vehicle-lead terms still open",
    blocks: [
      ...
      { type: "note", text: "DECIDED Aug 14, by Andrew: scout carry is 33% of the carried interest on the deal they source. The reason is the number's shape, not the market: at 33% the scout, Andrew and Iqram are equal thirds on that deal. It isn't priced off a benchmark, it's priced off the relationship, which is the whole thesis. Everything below is now context for how this number was reached, not an open menu. Two mechanics still need settling and they're flagged at the bottom." },
      { type: "note", text: "None of this is legal advice. Scout comp touches broker-dealer rules, so the 33% still gets run past fund counsel before anyone is promised anything, and the paperwork is what makes it real." },
      ...
      { type: "note", text: "SUPERSEDED, kept for the trail. My first recommendation was a flat 10%. My second was two tiers, 10% for a warm intro and 40\u201350% for a partner doing the work. Andrew's call on Aug 14 replaced both with a single 33%, and it's a better answer than either of mine for a reason neither of mine had: one published number that means 'equal partners' is a sentence you can say out loud to a Venmo alum, and a tier table isn't. I was optimising the price. He priced the relationship." },
      { type: "p", text: "Why 33% works better than the tiers I proposed:" },
      { type: "rows", rows: [
      ...
      { type: "p", text: "What 33% costs, run through real numbers so it's decided with eyes open. Assume $10M, 20% carry, and one big winner, because that's how this always goes:" },
      { type: "rows", rows: [
      ...
      { type: "note", text: "One number to nail down before this is written anywhere: 33% leaves 67% to split two ways, which is 33.5% each, so the scout is fractionally under equal. If the intent is literal thirds, the number is 33.33% and it should be drafted as 'one third,' not '33%.' Small thing, except the entire point of this number is that it means equal, and a Venmo alum with a calculator will notice." },
      ...
      { type: "people", items: [
        ...
        { name: "Option C \u00b7 Scout-plus", company: "Lightest", desc: "No management role at all. They source, we decide, they take the published one third of the deal carry, same as any other scout. Right answer if either of them actually wants a side thing, not a job. Note that after the Aug 14 decision this rung got a lot more generous, which makes it a genuinely good option for Rachel rather than a consolation prize.", tag: "Now the strong option for Rachel" }
      ]},
      ...
      { type: "list", items: [
        ...
        "DECIDED Aug 14: one third of the deal carry, so the scout is an equal partner with Andrew and Iqram on that deal. Supersedes the flat 10% and the two-tier 10 / 40\u201350 proposal.",
        "Open: is it drafted as 'one third' or as '33%'? Thirty-three leaves 33.5 each for the GPs, which is not quite equal, and equal is the entire point of the number.",
        "Open: is the third calculated on the deal's carry after fund expenses and LP preference, or on the deal's gross gain? This is the single most important unsettled mechanic and it's worth one email to counsel.",
        "Open: does a vehicle lead like Jonah get the same one third, or does running a vehicle earn more than sourcing one deal into it? A lead doing 20 deals at a third each is a different animal from a scout doing one.",
        "Open: does the one third apply inside the syndicate too, where there may be no traditional carry pool to split?",
